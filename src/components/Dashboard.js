...
import { html, toggleFlipCard, safe } from '../utils/ui';
...
function renderQuotaDetails(quota, percentage, isLow) {
    return html`
...
export function renderDashboard(contentEl, state) {
            ...
            <div id="flip-card-container" class="flip-card mt-4">
                <div class="flip-card-inner">
                    ...
                    <div id="flip-card-back" class="flip-card-back card relative text-left pt-6 pb-6 cursor-pointer">
                        ${renderQuotaDetails(quota, percentage, isLow)}
    ...
    document.getElementById('flip-card-front').addEventListener('click', toggleFlipCard);
    document.getElementById('flip-card-back').addEventListener('click', toggleFlipCard);
